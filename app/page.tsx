  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <HStack justifyContent={'space-between'} color={'aliceblue'} bg={'#13889f'} minHeight={500}>
        <Flex px={'5rem'} flexDirection={'column'} gap={'1.5rem'} flexBasis={'60%'} h={'500'} justifyContent={'flex-start'} alignItems={'left'} bg={''}>
          <Heading px={'0'} bgClip={'text'} color={'white'} as={'h1'} fontSize={'5xl'} mt={'100px'} fontFamily={'lexend'} bgGradient={'linear-gradient(to right, #121FCF 0%, #CF1512 100%)'}>The Shorter, The Better!</Heading>
          <Text fontSize={'xl'} fontFamily={'montserrat'} width={'lg'}> 
