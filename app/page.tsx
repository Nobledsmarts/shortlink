...
import { Box, Flex, HStack, Heading, Text, Image as ChackraImage} from '@chakra-ui/react'
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <HStack justifyContent={'space-between'} color={'aliceblue'} bg={'#13889f'} minHeight={500}>
        ...
        <Box borderRadius={'50%'} position={'absolute'} left={'-40px'} zIndex={1} top={'100px'} width={'100%'} overflow={'hidden'} border={'0px'} py={'0px'} height={'100px'} w={'100px'}>
        ...
        <Box borderRadius={'50%'} position={'absolute'} left={'0px'} zIndex={1} bottom={'-10px'} width={'100%'} overflow={'hidden'} border={'0px'} py={'0px'} height={'100px'} w={'100px'}>
        
          <ChackraImage style={{zoom : 1}} color='#e50000'  src={'/wave.svg'} alt='' width={'inherit'} height={'100'}/>
        </Box>
      </HStack>
    </main>
  )
